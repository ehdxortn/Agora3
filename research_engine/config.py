...
class Settings:
 ...
 literature_retrieval_limit:int=_int("LITERATURE_RETRIEVAL_LIMIT",18);failure_retrieval_limit:int=_int("FAILURE_RETRIEVAL_LIMIT",16);topic_reuse_min_sources:int=_int("TOPIC_REUSE_MIN_SOURCES",0);literature_map_refresh_delta:int=_int("LITERATURE_MAP_REFRESH_DELTA",20)
